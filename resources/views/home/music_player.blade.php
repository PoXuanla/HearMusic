<div style="position: fixed;background-color: white;bottom: 0;width:25%;
  right: 0;border-radius: 10px;overflow: hidden;     z-index: 1;">
    ...
    <div class="d-flex justify-content-between align-items-center" style="width: 80%; margin: 0 auto;">
        <img src="https://cfstatic.streetvoice.com/music_albums/ps/s/pss/f3880542391446b68f42ada09a4f28f2.jpg?x-oss-process=image/resize,m_fill,h_300,w_300,limit_0/interlace,1/quality,q_85/format,jpg" alt=""
